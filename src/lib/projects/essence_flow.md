---
title: "基于本地LLM的个人情报自动化系统"
category: "通过播客音频的转写与说话人分离，结合LLM生成内容摘要与结构化笔记，实现从“声音”到“知识”的自动化转化流程。"
year: "2024"
image: "/images/projects/essence_flow/cover.png"
color: "#4F46E5"
---

## 通过播客音频的转写与说话人分离，结合LLM生成内容摘要与结构化笔记，实现从“声音”到“知识”的自动化转化流程。

![img](/images/projects/essence_flow/cover.png)

我的角色

解决方案调研、多模态技术选型、全链路流程设计、技术开发与落地

## 背景

因不想打开社媒APP就被算法喂食，也不想被视觉和情绪干扰，我希望构建一套脱离App的高质量信息流，将自己关注的博主播客或社媒内容，自动抓取并形成结构化的知识，归档为可检索的Notion笔记。
...
![img](/images/projects/essence_flow/1.png)
![img](/images/projects/essence_flow/2.png)
![img](/images/projects/essence_flow/3.png)
![img](/images/projects/essence_flow/4.png)
![img](/images/projects/essence_flow/5.png)



## 我的目标是构建一套主动感知型的知识流水线：实现从自动监听博主更新到结构化归档至 Notion 的端到端闭环，而市面上的工具大多是一个内容辅助阅读器。

因此，我打算根据自己的使用习惯，自制一个播客小助手，打造更符合个人节奏和理解路径的工具，顺便学习一下相关技术。

我计划使用 Streamlit 快速搭建核心功能的原型，聚焦以下流程：
...
- **pyannote.audio**
    ...
    ![img](/images/projects/essence_flow/6.png)
...
![img](/images/projects/essence_flow/7.png)
...
![img](/images/projects/essence_flow/8.png)
...
![img](/images/projects/essence_flow/12.png)
...
![img](/images/projects/essence_flow/11.png)

### **交互原型**

![img](/images/projects/essence_flow/9.png)

### 最终Demo

![demo.gif](/images/projects/essence_flow/demo.gif)
